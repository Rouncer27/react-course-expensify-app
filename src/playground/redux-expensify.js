...
const filterssReducer = (state = filtersReducerDefaultState, action) => {
	switch (action.type) {
...
// store.dispatch(editExpense( expenseTwo.expense.id, { description: 'Coffee in San Fran!', amount: 500 } ) );
